...
class Config
{
    ...
    public const XML_CONFIG_PATH_IS_INTEGRATION_TEST_RUN = 'payment/amwal_payments/integration_test_run';
  ...
  /**
     ...
     * @return bool
     */
    public function isIntegrationTestRun(): bool
    {
        return $this->scopeConfig->isSetFlag(self::XML_CONFIG_PATH_IS_INTEGRATION_TEST_RUN);
    }
