...
namespace Amwal\Payments\Model\Payment;
...
class Method extends AbstractMethod
{
    ...
    private \Amwal\Payments\Model\Config $config;
    ...
    public function __construct(
        ...
        \Amwal\Payments\Model\Config $config,
    ...
    {
        if ($this->config->isActive() && $this->config->isRegularCheckoutActive()) {
            return true;
        }
    ...
    {
        return $this->config->getPaymentConfig($field, $storeId);
    }
