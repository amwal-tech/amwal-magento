...
class GetQuote extends AmwalCheckoutAction
{
    ...
    public function execute(
        ...
        try {
            ...
            // Check if the quote has virtual items, as they are not supported.
            if ($quote->hasVirtualItems()) {
                $this->throwException(__('Virtual products are not supported.'));
            }
            if (!$quote->getItems()) {
     ...
     * @throws LocalizedException
     */
    public function getCustomerAddress(DataObject $amwalOrderData, string $refId, $customerId): AddressInterface
    {
        $customerAddress = null;
        try {
