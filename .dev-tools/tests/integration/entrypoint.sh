...
cd $MAGENTO_ROOT/dev/tests/integration && ../../../vendor/bin/phpunit -c phpunit.xml && mkdir -p $GITHUB_WORKSPACE/coverage && cp -R $MAGENTO_ROOT/dev/tests/integration/coverage $GITHUB_WORKSPACE/coverage && ls $GITHUB_WORKSPACE/coverage
