...
echo "chmod -R 777 /home/coverage" >> ../../../entrypoint.sh
echo "echo 'Code coverage report is available at /home/coverage/cobertura.xml'" >> ../../../entrypoint.sh
tail -n 5 ../../../entrypoint.sh
